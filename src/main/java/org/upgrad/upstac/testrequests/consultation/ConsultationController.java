...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations()  {
        ...
        return new TestRequestQueryService().findBy(RequestStatus.LAB_TEST_COMPLETED);
    }
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        //throw new ResponseStatusException(HttpStatus.NOT_IMPLEMENTED,"Not implemented");
        User doctor = userLoggedInService.getLoggedInUser();
        return new TestRequestQueryService().findByDoctor(doctor);
    }
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        try {
            ...
            return new TestRequestUpdateService().assignForConsultation(request.getRequestId(),doctor);
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        try {
           ...
           // throw new ResponseStatusException(HttpStatus.NOT_IMPLEMENTED,"Not implemented");
            User doctor = userLoggedInService.getLoggedInUser();
            TestRequest request = new TestRequest();
            return new TestRequestUpdateService().updateConsultation(request.getRequestId(),new CreateConsultationRequest(),doctor);
